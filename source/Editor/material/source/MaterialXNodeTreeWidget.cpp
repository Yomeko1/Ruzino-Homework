    ...
    /*   UiNodePtr copyNode =
       ...
       if (node->getElement()) {
           ...
           if (getMaterialXNode(node)) {
               mx::NodePtr mxNode;
               mxNode =
                   _currGraphElem->addNodeInstance(getMaterialXNode(node)->getNodeDef());
               mxNode->copyContentFrom(getMaterialXNode(node));
...
std::vector<int> MaterialXNodeTreeWidget::createNodes(bool nodegraph)
{
    ...
    //         if (getMaterialXNode(node) != nullptr) {
    //             ed::BeginNode(node->ID);
    //             ImGui::PushID(node->ID);
    ...
    //            if (getMaterialXNode(node)->getType() ==
    //                mx::SURFACE_SHADER_TYPE_STRING) {
...
void MaterialXNodeTreeWidget::propertyEditor()
{
    ...
    //        if (temp != original) {
    //            std::string name = getMaterialXInput(_currUiNode)
    //                                   ->getParent()
    //                                   ->createValidChildName(temp);
    //            std::vector<UiNodePtr> downstreamNodes =
    //                _currUiNode->getOutputConnections();
    ...
    //        if (temp != original) {
    //            std::string name = getMaterialXOutput(_currUiNode)
    //                                   ->getParent()
    //                                   ->createValidChildName(temp);
    ...
    //        ImGui::Text(
    //            "%s", getMaterialXOutput(_currUiNode)->getCategory().c_str());
    //    }
...
void MaterialXNodeTreeWidget::drawGraph()
{
    ...
    //     if (_currUiNode != nullptr) {
    //         if (getMaterialXNode(_currUiNode) != nullptr) {
    //             mx::InterfaceElementPtr impl =
    //                 getMaterialXNode(_currUiNode)->getImplementation();
