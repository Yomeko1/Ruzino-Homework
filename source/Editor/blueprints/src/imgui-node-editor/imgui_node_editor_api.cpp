...
void ax::NodeEditor::BeginPin(SocketID id, PinKind kind)
{
...
bool ax::NodeEditor::QueryNewLink(SocketID* startId, SocketID* endId)
{
...
bool ax::NodeEditor::QueryNewLink(
    SocketID* startId,
    SocketID* endId,
    const ImVec4& color,
    float thickness)
...
bool ax::NodeEditor::QueryNewNode(SocketID* pinId)
{
    using Result = ax::NodeEditor::Detail::CreateItemAction::Result;
...
bool ax::NodeEditor::QueryNewNode(
    SocketID* pinId,
    const ImVec4& color,
    float thickness)
{
...
bool ax::NodeEditor::QueryDeletedLink(
    LinkId* linkId,
    SocketID* startId,
    SocketID* endId)
{
...
bool ax::NodeEditor::HasAnyLinks(SocketID pinId)
{
...
int ax::NodeEditor::BreakLinks(SocketID pinId)
{
...
bool ax::NodeEditor::ShowPinContextMenu(SocketID* pinId)
{
...
NodeId ax::NodeEditor::GetHoveredNode()
{
    return s_Editor->GetHoveredNode();
}

SocketID ax::NodeEditor::GetHoveredPin()
{
    return s_Editor->GetHoveredPin();
}

LinkId ax::NodeEditor::GetHoveredLink()
{
    return s_Editor->GetHoveredLink();
}

NodeId ax::NodeEditor::GetDoubleClickedNode()
{
    return s_Editor->GetDoubleClickedNode();
}

SocketID ax::NodeEditor::GetDoubleClickedPin()
{
    return s_Editor->GetDoubleClickedPin();
}

LinkId ax::NodeEditor::GetDoubleClickedLink()
{
...
bool ax::NodeEditor::GetLinkPins(
    LinkId linkId,
    SocketID* startPinId,
    SocketID* endPinId)
{
...
bool ax::NodeEditor::PinHadAnyLinks(SocketID pinId)
{
