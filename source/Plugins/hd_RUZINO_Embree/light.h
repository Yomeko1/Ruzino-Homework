...
using namespace pxr;
class Hd_RUZINO_Light : public HdLight {
   public:
...
class Hd_RUZINO_Sphere_Light : public Hd_RUZINO_Light {
   public:
...
class Hd_RUZINO_Dome_Light : public Hd_RUZINO_Light {
   public:
...
class Hd_RUZINO_Distant_Light : public Hd_RUZINO_Light {
   public:
...
class Hd_RUZINO_Rect_Light : public Hd_RUZINO_Light {
   public:
